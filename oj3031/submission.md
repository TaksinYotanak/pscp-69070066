...
```text
ให้เขียนโปรแกรมรับข้อมูลการขยายพื้นที่ที่เป็นวงกลม  ซึ่งมีค่าเท่ากับพื้นที่ขยายไปต่อหนึ่งวินาที และชาวบ้านอยากรู้ว่าบ้านจะโดนน้ำหมึกท่วมในกี่วินาที
Input:
รับพื้นที่น้ำหมึกขยายไปแล้ว , จำนวนคำร้องของชาวบ้าน

Output:
วินาทีที่น้ำหมึกจะท่วมบ้านของชาวบ้าน

Constraints:
พื้นที่นำหมึก S (1 <= S <= 100000) และจำนวนชาวบ้าน N (1 <= N <= 100)
```
...
```text
Step 1: รับค่าตัวแปร 2 ค่าในบรรทัดเดียวและสร้าง list เปล่า
Step 2: loop input เท่ากับค่าของตัวแปรที่ 2 
Step 3:เพิ่มสูตรใน loop เพื่อหาวินาที ที่น้ำจะท่วม
Step 4: เก็บไว้ใน list ที่สร้างไว้แรก และ loop มันออกมาทีละตัว
...
```text
เหมือนกับวิธีแรก เพราะเป็นแค่การเพิ่มสูตรไปไว้ใน loop พร้อมกับรับ input เพิ่้ม และเก็บไว้ใน list สุดท้ายจึง loop ค่อยออกมา
```
...
```text
เช็คว่าถ้าเกิดไม่เว้นวรรคใน input คำตอบจะออกมาเป็นไง
```
...
```text
เช็คว่าสูตรสามารถคำนวณออกมาได้เหมือน testcase โจทย์มั้ย
```
