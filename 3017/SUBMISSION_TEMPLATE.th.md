...
```
ให้คำนวณหาค่าอาหารที่ยังไม่รวม ค่าบริการและ Vat ของลูกค้าที่สั่งไป โดยที่ค่าบริการกำหนดไว้ที่ 10% และถ้าค่าบริการของราคาอาหารลูกค้าไม่ถึง 50 ให้คิดเป็น 50บาท และถ้าเกิน1000 ให้คิดเป็น 1000 บาท และนำค่าอาหาร + ค่าบริการ + Vat
```
...
```text
Step 1:สร้างตัวแปรเพื่อรับค่าอาหารของลูกค้าที่ยังไม่บวกค่าอื่นๆ
Step 2:นำค่าอาหารมาคูณ 10% เพื่อนำไปคำนวณในเงื่อนไข
Step 3:สร้างเงื่อนไขสำหรับค่าบริการ
```
...
```
ไม่เหมือนกับแผนแรก เพราะเปลี่ยนแปลงเงื่อนไขค่าบริการคือ ถ้าค่าบริการน้อยกว่า 50 ให้ค่าบริการเป็น 50 บาท แต่ถ้ามากกว่า 1000 ให้เป็น 1000
```
...
```
ถ้าหากไม่ใช้ f":.2f" คำตอบจะออกมาเป็นทศนิยมกี่ตำแหน่ง
```
...
```
ถ้าหากนำค่าอาหาร + ค่าบริการ + Vat ทีเดียว
```
...
```
ถ้าหากนำค่าอาหาร + กับค่าบริการก่อน แล้วค่อยนำไปบวกกับ Vat ตอนสุดท้าย
```
