...
Input:
รับค่าอุณหภูมิ
อักษรย่อของหน่วยค่าอุณหภูมิบรรทัดแรก
อักษรย่อของหน่วยค่าอุณหภูมิที่ต้องการ

Output:
เป็นอุณหภูมิที่ต้องการตามหน่วยในบรรทัดที่ 3 (ทศนิยม 2 ตำแหน่ง)

Constraints:
input เป็นจำนวนจริง ตามที่โจทย์ต้องการและ output ต้องเป็นทศนิยม 2 ตำแหน่ง
```
...
```text
Step 1: รับค่าตามที่โจทย์บอก
Step 2: เขียนเงื่อนไขสำหรับการแปลงทุกหน่วยให้เป็นหน่วยเซลเซียสก่อน
Step 3: เขียนเงื่อนไขถ้าหากต้องการหน่วยนี้ให้แปลงหน่วยเดิมเป็นเซลเซียสก่อน(กลับสูตร) และจากนั้นค่อยแปลงเป็นหน่วยที่ต้องการ
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก เพราะผมบังคับบรรทัดที่ 2 แปลงเป็นหน่วยเซลเซียสก่อนเพื่อหาหน่วยที่โจทย์ต้องการจะได้ไม่ยุ่งยากกับการกลับสูตรภายในเงื่อนไข
```
...
```text
เช็คว่าถ้าหากหน่วยเป็น Cและต้องการหน่วย C ควรจะแสดงออกมาเป็นค่าเดิม
```
...
```text
เช็คว่าถ้าหากหน่วยเป็น Rและต้องการหน่วย Fควรจะแสดงออกมาเป็นค่า F
```
...
```text
เช็คว่า output ออกมาเป็นทศนิยม 2 ตำแหน่ง
```
