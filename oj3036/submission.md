...
```text
โจทย์ให้รับค่าห้องว่าอยุ่ที่ห้องอะไร และหาว่าต้องพังกำแพงเท่าไหร่ถึงจะขึ้นไปถึงห้องที่1 (น้อยที่สุด)
```
...
```text
Step 1: รับค่า N (เลขห้อง)
Step 2: ใส่เงื่อนไข ถ้าอยู่ ห้องที่  1 ให้ output เป็น 0
Step 3: ให้ r เป็น แถวและหาว่า N อยู่แถวที่เท่าไหร่ของ r
Step 4: ให้ ans เป็นจำนวนกำแพงที่ต้องพัง สูตร 2 * (r - 1)
```
...
```text
ไม่เหมือน เพราะ เพิ่มเงื่อนไขอีกอันคือ ถ้า ห้อง N เป็นสามเหลี่ยนชี้ลง(เป็นเลขคี่) ก็คือให้พังกำแพงแค่ 1 อันเพราแผนอันแรกไม่ได้เช็คว่าสามเหลี่ยมชี้ขึ้นหรือลงเพราะปกติต้องพังกำแพง 2 อันถึงจพขึ้นไปชั้นถัดไปได้
```
...
```text
เช็คว่าถ้าเป็นสามเหลี่ยมชี้ลงจะต้องพังกำแพงแค่ 1 อัน
```
...
```text
เช็คว่าถ้าเป็นสามเหลี่ยมชี้ขี้นจะต้องพังกำแพงแค่ 2 อัน
```
...
```text
เช็คว่าถ้าหาก N อยู่ที่  1 ไม่ต้องพังกำแพง
```
