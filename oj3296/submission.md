...
```text
โจทย์ให้รับค่าสี 3 ค่า 2สี และหาค่าเฉลี่ยเมื่อนำ 2 สีมาผสมกัน
...
```text
Step 1: รับค่า 3 ค่าของแต่ละสี
Step 2: นำค่า3 ของแต่ละสีมาบวกกันและหาร 2
Step 3: แสดงค่าเฉลี่ย 3 ค่า
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก ฉันนำค่าแต่ละค่ามาบวกกันและหารด้วย 2
```
...
```text
ถ้า input เป็น 0 ควรจะออกมาเป็น 0 ทั้งหมด
```
...
```text
ถ้า input ติดลบควรจะแสดงค่าติดลบได้
```
