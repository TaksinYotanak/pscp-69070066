...
```text
เขียนโปรแกรมแสดงฤดูกาล 4 ฤดูกาลสําหรับเดือนและวันที่กําหนด และทุกๆ 3 เดือนจะต้องเปลี่ยนฤดูกาล

Input:
1.โปรแกรมรับ เดือน (จำนวนเต็ม)
2.โปรแกรมรับ วันที่ (จำนวนเต็ม)

Output:
ชื่อฤดูกาล

Constraints:
เงื่อนไขฤดูกาลจะเปลี่ยนไปตั้งแต่วันที่ 21 ของเดือนที่ 3 หารลงตัว(ไม่ใช่เดือนที่ 3)
```
...
```text
Step 1: สร้างตัวแปร 4 สำหรับเดือนสุดท้ายของแต่ละฤดูกาลเพื่อนำไปเข้าเงื่อนไข
Step 2:สร้างเงื่อนไขแต่ละฤดูกาล 
Step 3:แสดงผลฤดูต่างๆภายในเงื่อนไข
```
...
```text
เหมือนกับแผนแรกแต่เพิ่มเติมเงื่อนไขถ้าเป็นเดือนท้ายของแต่ละฤดูกาลและมากกว่าวันที่ 21 ให้แสดงเดือนถัดไป
ไม่งั้นถ้าเป็นเดือนที่ 12 และมากกว่า 21 มันจะไม่แสดงเดือนถัดไป
```
...
```text
เช็คเงื่อนไข เดือนที่ 1, 2, 3 เป็น ฤดูหนาว
```
...
```text
เช็คเงื่อนไข เดือนที่ 1, 2, 3 เป็นฤดูใบไม้ผลิ
```
...
```text
เช็คว่าถ้าหากเป็นเดือน 12 และมากกว่าวันที่ 21 ต้องออกมาเป็นฤดูหนาว
```
