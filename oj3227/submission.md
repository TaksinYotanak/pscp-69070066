...
```text
โจทย์ให้รับชื่อย่อไพ่และประเภทของไพ่ และแสดงออกมาและต้องรับได้ทั้งตัวพิมพ์ใหญ่และเล็ก
Input:
รับชื่อไพ่และประเถทของไพ่

Output:
แสดงผลตามชื่อของไพ่

Constraints:
ไพ่มี 44 ใบและไม่มีชื่อ 1 ,11,12 ในไพ่
```
...
```text
Step 1: อ่านตัวย่อไพ่
Step 2: เช็คว่าค่าที่รับมาอยู่ใน dict รึเปล่า
Step 3: ถ้าจริง ให้แสดงผลตามใน dict
Step 4: ถ้าไม่จริงไม่ต้องแสดง
```
...
```text
ต่างจากวิธีแรกคือถ้าไม่มีใน dict ให้แสดงตัวของมันออกมาเลยจะได้ไม่ต้องเขียน 2- 10 ใน dict
```
...
```text
ถ้ารับค่าตัวเลขมาด้วยควรจะแสดงตัวเลขด้วย
```
...
```text
ถ้าหากไม่ใช้ upper หรือ lower ใน input ไม่ควรผ่าน
```
