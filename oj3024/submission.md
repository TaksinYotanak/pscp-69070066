...
```text
โจทย์ให้สร้างระบบที่มีโอกาสที่จะเกิด Surprising หรือไม่ถ้าคะแนนของคนที่ให้คะแนนสูงสุด และคะแนนต่ำสุดห่างกันเกินสองคะแนน
Input:
รับคะแนนรวมทั้ง 3 คน
รับคะแนนสูงสุดของทั้ง 3 คน

Output:
"Surprising" หรือ "Not surprising"

Constraints:
input ต้องเป็นจำนวนจริง output เป็นได้แค่ 2 ค่า "Surprising" หรือ "Not surprising"
```
...
```text
Step 1: สร้างตัวแปรรับค่ารวมและค่าสูงสุดของทั้ง 3 คน
Step 2: สร้างตัวแปรเพื่อหาคะแนนที่น้อยที่สุด
Step 3: หาคะแนนที่น้อยที่สุดด้วยการ นำ คะแนนทั้งหมด - (คะแนนสูงสุด * 2)
Step 4:ถ้าคะแนนห่างกันเกิน 2 แสดง Surprising ถ้าไม่ Not surprising
```
...
```text
เหมือนกับวิธีแรกแต่แค่เพิ่มเงื่อนไขถ้าคะแนนน้อยที่สุด น้อยกว่า 0 ให้เป็น 0 (กันกรณีใส่คะแนนติดลบ)
```
...
```text
เช็คว่าถ้าห่างกันเกิน 2 คะแนนควรจะ Surprising
```
...
```text
เช็คว่าถ้าหากคะแนนติดลบจะยังสามารถคำนวณได้
```
...
```text
เช็คว่าถ้าห่างกันน้อยกว่า 2 คะแนนควรจะ Not surprising
```
