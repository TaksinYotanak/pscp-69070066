...
```text
โจทย์ให้หาว่ามีสระ eng กี่ตัวใน input ที่รับเข้ามา
Input:
โปรแกรมรับตัวอักษร
...
Constraints:
รับข้อความความยาว อยู่ในช่วง 1<=n<1000 และแสดงสระที่มากว่า 0 เท่านั้น
```
...
```text
Step 1: รับค่า string เป็นตัวเล็กทั้งหมด
Step 2: สร้าง list ที่ข้างในมีสระตัวพิมพ์เล็ก
Step 3:ให้ i loop แต่ละตัวที่รับ input เข้ามาว่าตรงกับใน list มั้ย
Step 4: ถ้าตรงให้แสดงสระที่ตรงและ จำนวนของมัน
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรกฉันรับค่า inputเป็นตัวเล็กเพื่อป้องกันเคสที่มีตัวพิมพ์ใหญ่เข้ามาเพื่ให้เช็คได้
```
...
```text
เช็คว่าถ้าเกิดตัวอื่นที่เป็น 0 ไม่ควรแสดงออกมา
```
...
```text
เช็คว่าสามารถเช็คและแสดงออกมาเหมือน testcase sample ได้มั้ย
```
...
```text
ถ้าหากไม่รับ input.lower() ถ้ามีตัวใหญ่เข้ามาไม่ควรเช็คได้
```
