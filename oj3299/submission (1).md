...
```text
โจทย์ให้หาว่าต้นสุดท้ายที่ปลูกอยู่แถบที่เท่าไหร่

Input:
รับค่าหลัง และ ช่อง 2 ค่าใน 1 บรรทัด

Output:
แถบของช่องสุดท้ายที่ปลูกดอกไม้

Constraints:
L มีค่า 1 ถึง 10 และ N มีค่า 1 ถึง 100,000 โดย N คือจำนวนช่องที่ปลูกต้นไม้ทั้งหมด
```
...
Step 2: ใช้การบวกจำนวนช่องของแต่ละแนวทแยง เพื่อหาแนวที่มีช่อง N
Step 3: เมื่อรู้ว่า N อยู่แนวที่เท่าไร ให้หารแนวนั้นด้วย L เพื่อหาแถบ
Step 4: แสดงหมายเลขแถบที่ได้
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรกใช้การบวกจำนวนช่องของแต่ละแนวทแยง เพื่อหาแนวที่มีช่อง Nและใช้หารแนวนั้นด้วย L เพื่อหาแถบ
```
...
```text
ถ้า input เป็น 0 ทั้งหมด ควรจะ Error
```
...
```text
ถ้า input เป็นติดลบ ทั้งหมดควรจะแสดงค่าออกมาได้
```
