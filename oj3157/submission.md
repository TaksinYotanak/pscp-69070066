...
```text
โจทย์ให้ฉันหาคะแนนรวมรับค่าจำนวนเต็มและรับค่าเครื่องหมายหากเป็นบวก  เพิ่ม 10 คะแนน และลบ ลด 5 คะแนน
...
Constraints:
input เป็นจำนวนเต็ม (1 ≤ N ≤ 1,000) เครื่องหมายมีแค่ (+ หรือ -) คั่นด้วยช่องว่าง
```
...
Step 2: loop ตามจำนวนเต็มและรับค่าเครื่องหมาย
Step 3: หากเป็น + ให้เพิ่ม 10 คะแนน
Step 4: หากเป็นลบให้ลด 5 คะแนน
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก รับค่ามาแล้วloop และรับค่าเครื่องหมายตามจำนวนเต็มและทำตามที่เงื่อนไขโจย์ให้มา
```
...
```text
หาก input ติดลบจะไม่สามารถนับคะแนนได้
```
...
```text
เช็คว่าถ้าเป็นเครื่องหมายบวกควรจะเพิ่มทีละ 10
```
...
```text
เช็คว่าถ้าเป็นเครื่องหมายลบควรจะลดทีละ5
```
