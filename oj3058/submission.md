...
```text
ให้หาว่าเมื่อนำอิฐมาต่อกันสร้างเป็นสะพาน จะต้องใช้อิฐก้อนเล็กน้อยที่สุดกี่ก้อน และต้องใช้ก้อนใหญ่ให้หมดก่อนเสมอ
...
Output:
จำนวนหินก้อนเล็กที่ใช้ หรือ ถ้าสร้างไม่ได้ให้พิมพ์ "-1"

Constraints:
ก้อนเล็กมีขนาด 1 นิ้ว,ก้อนใหญ่มีขนาด 5 นิ้ว และต้องใช้ก้อนใหญ่ให้หมดก่อนเสมอ5ถ้าไม่พอให้นำก้อนเล็กมาโปะ
```
...
```text
Step 1: รับค่าหินเล็กใหญ่ และจำนวนหินที่ต้องการ
Step 2: เช็คว่าต้องใช้หินใหญ่กี่ก้อน
Step 3: หาจำนวนหินเล็กที่ต้องการใช้
Step 4:ถ้าหินเล็กมีค่าน้อยกว่าหรือเท่ากับ ค่าหินก่อนเล็ก พิมพ์ "จำนวนหินก้อนเล็ก" ถ้าไม่พิมพ์ "-1"
```
...
```text
เหมือนกับแผนแรก ผมลองให้ ก้อนใหญ่เป็น 0 ดูแล้วดูว่ามันใช้แค่หินก้อนเล็กซึ่งแสดงว่าแผนแรกโอเคแล้ว
```
...
```text
ถ้าเกิดให้ก้อนใหญ่เป็น 0 ก้อนควรจะใช้ก้อนเล็กทั้งหมด
```
...
```text
ถ้าเกิดหินไม่พอควรจะแสดงเป็น -1
```
...
```text
ถ้าเกิดหินพอจะแสดงก้อนหินเล็กที่ใช้น้อยที่สุด
```
