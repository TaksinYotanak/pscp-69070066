...
```text
โจทย์ให้เขียนโปรแกรมคำนวณค่าธรรมเนียมการส่งพัสดุจะต้องเลือกต้นทาง - ปลายทาง 

Input:
รับค่าต้นทาง ปลายทาง

Output:
แสดงผลราคาการนําส่งพัสดุที่ได้จากข้อมูลนําเข้า

Constraints:
input เป็นภาษาอังกฤษตัวพิมพ์ใหญ่เท่านั้น
```
...
```text
Step 1: รับค่าจังหวัดต้นทาง ปลายทาง
Step 2: เช็คเงื่อนไขตามตารางราคาที่โจทย์ให้มา
Step 3: แสดงราคาการนำส่งพัสดุ
Step 4: ถ้าเส้นทางไม่อยุ่ในตารางให้แสดง "Error"
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก ใช้เงื่อนไขตามตารางที่โจทย์กำหนดมาให้
```
...
```text
เช็คว่าถ้าเส้นทางไม่อยู่ในตารางควรแสดง Error
```
...
```text
เช็คว่าราคาถูกต้องตามต้นทางและปลายทางที่ต้องนำส่ง
```
...
```text
ถ้าเกิดไม่ใช้ f string ข้อนี้ไม่ควรจะผ่าน
```
