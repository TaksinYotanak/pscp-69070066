...
```
นำแม่สี 3 สีมาผสมกันและถ้า input สีอื่นเข้ามาให้ Output เป็น Error
```
...
```text
Step 1:สร้างตัวแปร Color1, Color2 เพื่อรับ input 2 สีมาผสมกัน
Step 2:สร้างเงื่อนไข ตามโจทย์ที่ให้มาเพื่อให้ได้ output ตามโจทย์
Step 3:สร้างเงื่อนไขถ้า input สีอื่นเข้ามาให้ Output เป็น Error
```
...
```
ไม่เหมือนกับแผนแรก เพราะแผนสุดท้ายคือสร้างเงื่อนไขเพิ่มสำหรับ input ที่สี Color1,Color2 เหมือนกัน
```
...
```
ถ้าไม่เพิ่มเงื่อนไขถ้ามีinput สีอื่นนอกจากแม่สีที่กำหนดไว้เข้ามา
```
...
```
ถ้าหากไม่เพิ่มเงื่อนไขสำหรับ input แม่สีเดียวกันจะเป็นยังไง
```
...
```
ทดสอบเงื่อนไขแรกที่นำแม่สีที่ต่างกันมาผสมกันว่าถูกต้องมั้ย
```
