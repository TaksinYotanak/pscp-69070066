...
```text
รับค่า string เข้ามา 5 บรรทัด และแสดงค่าตัวอักษรที่อยู่ใน string นั้นในกรอบรูปสี่เหลี่ยม

Input:
รับข้อความจำนวน 5 บรรทัด

Output:
แสดงข้อความที่อยู่ในกล่อง

Constraints:
input รับได้แค่ 5 บรรทัดเท่านั้น
...
```text
Step 1: loop รับค่า 5 บรรทัด
Step 2: สร้าง list และตัวแปรเก็บที่ยาวที่สุดเก็บไว้
Step 3: loop เช็คในลิสว่าตัวไหนยาวที่สุด
Step 4: แสดงกรอบบนและล่างโดยนำตัวที่ยาวที่สุดมาบวก 4
Step 5: แสดงข้อความด้านในกล่องตามที่โจทย์ต้องการ
```
...
```text
เหมือนกับแผนแรกผมหาช่องว่าในกล่องคือ นำตัวที่ยาวที่สุดมาลบกับข้อความในแต่ละบรรทัดและคูณ *
...
```text
input เป็นตัวเลขควรจะออกมาเป็นตัวเลข
```
...
```text
ถ้าไม่ใส่ input ควรจะออกมาเป็นช่องว่างในกล่อง
```
...
```text
ข้อความในกล่องควรจะเว้นช่องว่างให้เท่ากับตัวที่ยาวที่สุดในกล่อง
```
