...
```text
โจทย์ให้เช็คว่าจากระยะนึงไปถึงอีกระยะต้องกระโดดกี่ก้าวและในแต่ละก้าวจะลดลงทีละ 2

Input:
รับค่า ระยะเริ่มถึง สิ้นสุด

Output:
พิมจำนวนครั้งที่กระโดด
...
```text
Step 1: รับค่าระยะเริ่ม และสิ้นสุด
Step 2: loop ให้ลดทีละ 2 และเก็บระยะทางและเก็บค่าทีละ 1 ในการกระโดด
Step 3:ถ้าเกิดระยะทางมากกว่าหรือเท่ากับค่าสิ้นสุดให้ หยุด loop
Step 4: ถ้าเกิดระยะทางน้อยกว่าค่าสิ้นสุดให้พิมพ์ -1
```
...
```text
เหมือนกับวิธีแรก ผมใช้ loop ในการลดลงทีละ 2 และเพิ่มเงื่อนไขเพื่อเช็คตามโจทย์
```
...
```text
ถ้า input ไม่สามารถไปถึงจุดสิ้นสุดได้ควรจะออกมา -1
```
...
```text
ถ้ากระโดดถึงควรจะแสดงจำนวนที่กระโดด
```
...
```text
ถ้าเกิดเป็น 0 จะไม่มีการกระโดด
```
