...
```text
โจทย์ให้เขียนโปรแกรมเช็คลอตตารี่ และทำตามเงื่อนไขที่โจทย์กำหนด
...
Constraints:
รางวัลจะได้แค่หนึ่งเดียวไม่มีโบนัส
```
...
```text
Step 1:รับค่าลอตตารี่
Step 2: เช็คตามที่เงื่อนไขโจทย์ให้มา
Step 3: ถ้าจริงก็ให้ออกมาตามที่โจทย์ต้องการ
Step 4: ถ้าไม่จริงให้ พิมพ์ 0
```
...
```text
เหมือนกับวิธีแรกแต่ว่าในเงื่อขไขเช็คว่า3 ตัวท้ายกับ 2 ตัวท้าย ผมเอาเงื่อไขเช็ค 3 ตัวไว้ข้างบนเพราะถ้าหากเอา 2 ไว้บนถ้้า3 ตัวท้ายถูกมันจะได้รางวัลของ 2 ตัวท้าย
```
...
```text
เช็คว่า 2 ตัวท้ายตรงและอักษรตรงควรจะออก  100
```
...
```text
เช็คว่า 3 ตัวท้ายตรงและอักษรไม่ตรงควรจะออก  200
```
...
```text
ถ้าหากตรงทุกตัวควรจะออก 1000000
```
