...
```text
โจทย์ให้หาตัวเลขระหว่าง A ถึง B ว่ามีกี่ตัวที่หารด้วย d แล้วเหลือเศษ r
Input:
โปรแกรมรับจำนวนตัวเลข 4 บรรทัด

Output:
โปรแกรมควรพิมพ์จำนวณที่หารเข้าเงื่อนไข
...
```text
Step 1:รับค่า A,B
Step 2:สร้างตัวแปร x ไว้เก็บเลขที่เข้าเงื่อนไข
Step 3: loop ใน A-B และตรวจสอบว่าหารด้วย d แล้วเหลือ เศษ = r กี่ตัว
Step 4: ถ้าจริงให้ เพิ่มเข้าไปในตัวแปร x
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก ผมใช้ loop และสร้างเงื่อนไขสำหรับเช็คว่ามีกี่ตัวตามที่โจทย์ต้องการ
```
...
```text
ตรวจเช็คว่าผลลัพพ์ตรงกับ testcase sample 
```
...
```text
เช็คว่าถ้าเกิด a,b เป็น0 output ควรเป็น 0
```
...
```text
เช็คว่า testcase ตรวงกับ sample testcase 
```
