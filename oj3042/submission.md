...
```text
เขียนโปรแกรมรับค่า ตั้งแต่ N ถึง 0 เป็นจำนวนเต็มและหาว่ามีจำนวนอะไรบ้างที่หาร 10 ลงตัวและแสดงออกมา
...
Constraints:
input เป็นจำนวนเต็ม และ output ต้องออกมาเป็นบรรทัดเดียวกัน ต้องเช็คด้วยว่าต้องเว้นวรรคใน output
```
...
```text
Step 1: รับค่า N
Step 2: loop N ให้นับถอยหลังถึง 0
Step 3: ถ้า N หาร 10 ลงตัว พิมพ์ N
```
...
```text
เหมือนกันแต่ เพิ่ม end = " " ในบรรทัด output เพราะโจทย์บอกว่าต้องเป็นบรรทัดเดียว
```
...
```text
ถ้าใส่ 0 ใน range (N,-1,-1) ควรจะแสดง 0 ด้วย
```
...
```text
ถ้าเกิดไม่ใส่วรรคข้างใน end = " " ตัวเลขควรจะติดกัน
```
