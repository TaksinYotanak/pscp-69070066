...
```text
โจทย์ให้คิดเงินสินค้าถ้าเป็นสมาชิกให้รวมยอดลด 5% ถ้าไม่และสินค้ารวม >= 500ให้ลดแค่ 3% แต่ถ้ากรณีอื่นๆไม่ลด

Input:
โปรแกรมรับค่าสมาชิกและจำนวณสินค้า

Output:
ยอดสุทธิหลังหักส่วนลด

Constraints:
ต้องเป็นทศนิยม 2 ตำแหน่งและปัดเศษมาตรฐาน
...
```text
Step 1: รับค่าสมาชิก
Step 2: หากเป็นให้ลด 5% แต่ถ้าไม่และยอด >= 500 ให้ลด  3% อื่นๆไม่ลด
Step 3: ใช้ math.ceil ในการปัดเศษ
```
...
```text
วิธีสุดท้ายของฉันต่างจากแผนแรก เพราะฉันเปลี่ยนไปใช้ decimal ในการปัดเศษและทำทศนิยม 2 ตำแหน่งเพื่อลดปัญหาปัดเศษยุ่งยากใน float
```
...
```text
เช็คว่ายอดรวมและหักส่วนลดแล้วควรออกมาถูกต้อง
```
...
```text
ใช้ round ในการปัดเศษควรใช้ได้
```
...
```text
ใช้quantize กำหนดตำแหน่งทศนิยม 2 ตำแหน่ง
```
...
```text
ฉันถามวิธีที่เค้าใช้ในการปัดเศษ
```
